...
//   };
  ...
  render() {
    ...
    const sideList = side => (
      ...
      >
      {this.state.redirectVarHome && <Redirect to="/"/>}
      <ListItem button key="Home" className="item-drawer" onClick={() =>{this.handlehomeClick()}}>
      ...
      <ListItem button key="Recommend By Genre" className="item-drawer" onClick={() =>{this.handlerangeClick()}}>
      <ListItemText primary="Recommend By Genre"  />
      </ListItem>
      <Divider />
